...
if (!window.Typekit)
    window.Typekit = {};
window.Typekit.config = {"a": "610279", "c": [".tk-source-code-pro", "\"source-code-pro\",sans-serif", ".tk-klavika-web", "\"klavika-web\",sans-serif"], "f": "/HuidaSvc/js/use.typekit.net/c/29b1ce/1w.css;klavika-web,2,PYh:F:i7,PYg:F:n7;source-code-pro,2,Y1M:F:n4,Y1P:F:n7/{format}{/extras*}?", "fi": [17451, 17454, 7080, 7079], "fn": ["klavika-web", ["i7", "n7"], "source-code-pro", ["n4", "n7"]], "ht": "tk", "js": "1.2.2", "k": "/HuidaSvc/js/use.typekit.net/{id}.js", "kt": "wde1aof", "l": "typekit", "p": "//p.typekit.net/p.gif?s=1&k=wde1aof&ht=tk&h={host}&f=17451.17454.7080.7079&a=610279&_={_}", "ps": 1, "w": "wde1aof"};
/*{"k":"1.2.2","auto_updating":false}*/
...
(function (window, document, undefined) {
    ...
    ba.prototype.parse = function () {
        ...
        if (-1 != this.e.indexOf("MSIE")) {
            ...
            a:if (c = a = "Unknown", b = z(this.e, /(Presto\/[\d\w\.]+)/, 1), "" != b ? (c = b.split("/"), a = c[0], c = c[1]) : (-1 != this.e.indexOf("Gecko") && (a = "Gecko"), b = z(this.e, /rv:([^\)]+)/, 1), "" != b && (c = b)), -1 != this.e.indexOf("Opera Mini/"))
                b =
    ...
    function H(a, c, b) {
        c = a.g.createElement("span", {style: na(a, c, a.U, b)}, a.Ia);
        r(a.g, "body", c);
        return c
    }
    function na(a, c, b, d) {
    ...
    o.load = function (a, c) {
        ...
        this.S && (d = [], this.R && (d = new Da(this.g, this.r, this.n), d = Ea(this.R, b, d)), b = this.S.h(J(this.g), Fa(b, d)), r(this.g, "head", this.g.createElement("link", {rel: "stylesheet", href: b})));
        ...
        this.$ && s(function (a, b, d, e) {
            return function () {
                ...
                if (b.ua) {
                    ...
                    xa(b.ua.h(J(e), {host: encodeURIComponent(e.j.location.hostname), app: encodeURIComponent(h), _: (+new Date).toString()}))
                }
                b = a.$;
    ...
    function Ga(a, c, b) {
        ra(a.g, a.Pa.h(J(a.g), {id: encodeURIComponent(c)}), b)
    }
    function Ha(a, c) {
        if (0 != a.q.length) {
    ...
    function Ja(a, c) {
        ...
        for (var d = new E(a.g, c, {Y: function (a) {
